...
$query = "select nilai.nilai_id, users.users_nama,pelajaran.pelajaran_nama,
jenis.jenis_nama,tahun.tahun_nama,nilai.nilai_poin
 from nilai,users,pelajaran,jenis,tahun
 where nilai.users_id=users.users_id 
 and nilai.pelajaran_id=pelajaran.pelajaran_id 
 and nilai.jenis_id=jenis.jenis_id 
 and nilai.tahun_id=tahun.tahun_id";
$results = mysql_query($query) or die("Error: ".mysql_error($connect));
$data = array();
...
$judul = "LAPORAN NILAI TUGAS SISWA ";
$judul1 = "SMP N 1 SEDAYU";
$judul7 = "Alamat: Jl.Pedes-Nulis,Panggang,Argomulyo,Sedayu,Bantul,DIY ";
$header = array(
		array("label"=>"ID", "length"=>1, "align"=>"C"),
		array("label"=>"Nama Siswa", "length"=>7, "align"=>"C"),
		array("label"=>"Mata Pelajaran", "length"=>4, "align"=>"C"),
		array("label"=>"Jenis", "length"=>2, "align"=>"C"),
		array("label"=>"Tahun", "length"=>3, "align"=>"C"),
