    ...
    <div class="box">
        <div class="box-header bg-transparent">
            ...
            <h3 class="box-title"><i class="fontello-th-large-outline"></i>
                <span>Input Penilainan Harian 3</span>
            </h3>
        </div>
	...
	<div class="box">
		<table class="box-header bg-transparent"  style="width:100%">
			...
			<form role="form" method="post" />
				...
				?>		
				<tr>
					<td colspan="3" align="right" valign="baseline"><button type="submit" class="btn btn-success" name="uh3-proses"><span class="fa fa-gear"></span> Proses</button></td>
				</tr>
			</form>
			<?php 
				}
