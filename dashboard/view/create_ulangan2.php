    ...
    <div class="box">
        <div class="box-header bg-transparent">
            ...
            <h3 class="box-title"><i class="fontello-th-large-outline"></i>
                <span>Input penilaian harian 2</span>
            </h3>
        </div>
		...
		<form role="form" method="POST"> 
			...
			<div class="form-group"> 
				...
				<select name="pelajaran" class="form-control" disabled>
					<?php 
					 $idu= $_SESSION['id'];
                                $pelajaran      =   mysql_query("SELECT * FROM pelajaran WHERE pelajaran.users_id='$idu' ORDER BY pelajaran_id ASC");
	...
	<div class="box">
		<table class="box-header bg-transparent"  style="width:100%">
			...
			<form role="form" method="post" />
				...
				?>		
				<tr>
					<td colspan="3" align="right" valign="baseline"><button type="submit" class="btn btn-success" name="uh2-proses"><span class="fa fa-gear"></span> Proses</button></td>
				</tr>
			</form>
			<?php 
				}
