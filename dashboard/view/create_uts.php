    ...
    <div class="box">
        <div class="box-header bg-transparent">
            ...
            <h3 class="box-title"><i class="fontello-th-large-outline"></i>
                <span>Input Penilaian Ujian Tengah Semester</span>
            </h3>
        </div>
		...
		<form role="form" method="POST"> 
			...
			<div class="name-field"> 
				...
				<select name="pelajaran" class="form-control" required>
					<?php 
					$iduser = $_SESSION['id'];
						$pelajaran	=	mysql_query("SELECT * FROM pelajaran WHERE pelajaran.users_id='$iduser'");
			...
			<button class="btn btn-primary" type="submit" name="create-nilai"><span class="fa fa-plus"></span> Tambah Nilai UTS</button>
		</form>
	</div>
</div>
	...
	<div class="box">
		<table class="box-header bg-transparent"  style="width:100%">
			...
			<form role="form" method="post" />
				...
				?>		
				<tr>
					<td colspan="3" align="right" valign="baseline"><button type="submit" class="btn btn-success" name="uts-proses"><span class="fa fa-gear"></span> Proses</button></td>
				</tr>
			</form>
			<?php 
				}
