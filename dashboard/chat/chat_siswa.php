                        ...
                        <div class="box">
                            ...
                            <div class="box-body" style="display: block;">
                                <div class="school-timetable">
                                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="simpan_pesan1.php">
							<input type="hidden" name="nis" value="<?php echo $q['nis']; ?>">
							<input type="hidden" name="id_forum" value="<?php echo $m['id_forum']; ?>">
							<img src="../img/<?php echo $m['gambar']; ?>" width="30" height="30"/>
                                       <p><?php echo $m['nama']; ?></p>
                                        <p><?php echo $m['post']; ?></p>
                                   
                                       <p><?php echo $m['tanggal_post']; ?></p>
									   
                                        <?php
							$e=" SELECT * FROM detail_forum,siswa,forum 
							where detail_forum.nis=siswa.nis
							and forum.id_forum=detail_forum.id_forum
							and forum.id_forum='$m[id_forum]' order by detail_forum.id_detail_forum desc";
							$f=mysqli_query($connect, $e) or die ("error : ".mysqli_error($connect));
							while($g=mysqli_fetch_array($f)){							
							?>
							<img src="../img/<?php echo $g['gambar']; ?>" width="30" height="30"/>
                                       <p><?php echo $g['nama_siswa']; ?></p>
                                        <p><?php echo $g['komentar']; ?></p>
                                   
                                       <p><?php echo $g['tanggal_komentar']; ?></p>
						<?php  }  
							...
							<img src="../img/<?php echo $b['gambar']; ?>" width="30" height="30"/>
                                       <p><?php echo $b['nama']; ?></p>
                                        <p><?php echo $b['reply_guru']; ?></p>
                                   
                                       <p><?php echo $b['tanggal_reply']; ?></p>
						<?php  }  
