...
<div class="container" id="pcont">
	<div class="page-head">
		...
		<h4>SMP Muhammadiyah 1 Minggir</h4>
	</div>    
	<div class="cl-mcont">
<!-- ===================================== Content Here ===================================== -->
<div class="block-flat no-padding">
	<div class="content">
			...
			<thead class="no-border">
				...
				<?php 
					if (isset($_POST['cetak-nilai'])) {
						...
						$sql 		=	mysql_query("SELECT users.users_nama, pelajaran.pelajaran_nama, nilai.nilai_poin, jenis.jenis_nama, 
													semester.semester_nama, tahun.tahun_nama, kelas.kelas_id, kelas.kelas_nama 
													FROM nilai
													...
													WHERE users.users_id=$users
														AND jenis.jenis_id=$jenis 
														AND semester.semester_id=$semester 
		...
		<div class="container-fluid">
			<?php 
				if (isset($_POST['cetak-nilai'])) {
						...
						$sql 		=	mysql_query("SELECT users.users_nama, pelajaran.pelajaran_nama, nilai.nilai_poin, 
										jenis.jenis_nama, semester.semester_nama, tahun.tahun_nama, kelas.kelas_id, 
										kelas.kelas_nama 
													FROM nilai
													INNER JOIN users ON nilai.users_id=users.users_id
													INNER JOIN kelas ON users.kelas_id=kelas.kelas_id
				...
				<table class="no-border">
					<tbody class="no-border-x no-border-y">
						<tr>
							...
							<td>:</td>
							<td class="display"><?php echo $row['users_nama']; ?></td>
						</tr>
						<tr>
							<td style="width:15%;">Kelas</td>
							<td>:</td>
							<td class="display"><?php echo $row['kelas_nama']; ?></td>
						</tr>
						<tr>
							<td style="width:15%;">Jenis Nilai</td>
							<td>:</td>
							<td class="display"><?php echo $row['jenis_nama']; ?></td>
						</tr>
					</tbody>
				</table>
			</div>
		...
		<hr>
		<a href="../?cetak=laporan-nilai-siswa" cls='btn'><i class='fa fa-reply'></i> Kembali </a>
